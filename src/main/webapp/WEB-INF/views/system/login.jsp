...
<body>
	...
	<form id="loginForm" action="${ctx}/treesoft/loginVaildate" method="post">
		<div style="float:left;width:100%;" class="login_top">
			<div class="login_title" >
				<span style="margin-left: 10px; margin-top: 10px;color: #fff"> <img src="${ctx}/static/images/logo.png" >TreeSoft数据库管理系统<span style="color: #00824D;font-size:16px; font-weight:bold;">&nbsp;TreeDMS</span>  <span style="color: #fffl;font-size:12px;">V2.2.6</span> </span>
			</div>
		</div>
